      ...
      <div class="mb-10 grid gap-8 md:grid-cols-[220px_1fr] md:items-start">
        <div class="flex flex-col items-start gap-4">
          <img
            ...
            width="220"
            height="220"
            class="h-44 w-44 rounded-xl border border-gray-200 object-cover dark:border-[#364252] md:h-[220px] md:w-[220px] rotate-3"
          />
          <div class="flex items-center justify-between w-full">
            <a
              href="https://www.linkedin.com/in/gnaigaliot/"
              target="_blank"
