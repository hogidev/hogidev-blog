...
export default function ScrollToTopButton() {
  ...
  return (
    <>
      ...
      >
        <svg className="w-4 stroke-zinc-500 transition group-hover:stroke-zinc-700 dark:stroke-zinc-500 dark:group-hover:stroke-zinc-400" xmlns="http://www.w3.org/2000/svg" fill="none"
