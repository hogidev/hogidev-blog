  ...
  return (
    <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
      ...
      <div className="lg:order-first lg:row-span-2">
        <h1
          className="text-4xl font-extrabold tracking-tight sm:text-5xl dark:text-zinc-100"
        >
          Giang Tran
        </h1>
      ...
      <div className="lg:pl-20">
        <ul role="list">
            ...
            SOCIALS.map((social, index) => (
              <li key={index} className={`flex ${index > 0 ? 'mt-4' : ''}`}>
                <a
                  href={social.url}
                  target="_blank"
                  className="group flex text-sm font-medium transition hover:text-teal-500 dark:hover:text-teal-500 items-center text-zinc-600"
                >
          ...
          <li className="mt-8 border-t border-zinc-300 pt-8 dark:border-zinc-700/40 flex text-zinc-600">
            <a
            ...
            >
              ...
              <span className="ml-4">hoanggiang521999@gmail.com</span>
            </a>
          </li>
        </ul>
      </div>
